...
const reportUrl = `https://genomicexplorer.io/v2/reports/${name}/?population=${population}`;
request.get(reportUrl, options, function (error, response, body) { console.log(body); });
